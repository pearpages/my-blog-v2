module.exports = {
  someSidebar: {
    ...
    'External resources': [
      ...
      { type: 'link', label: 'Top 20 Javascript books', href: 'https://www.blog.consultants500.com/web-mobile-design-and-development/top-20-best-javascript-book-recommended-times-javascript-pros/' },
    ...
    'Functional JS': [
      ...
      { type: 'link', label: 'Mori', href: 'https://google.es' },
      { type: 'link', label: 'Ramda', href: 'https://google.es' },
    ],
    'Origami': [
